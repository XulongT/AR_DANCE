...
public class TrackerHandler : MonoBehaviour
{
    ...
    public void renderSkeleton(Body skeleton, int skeletonNumber, MotionRecorder recorder=null)
    {
        // save joinnts data
        Vector3[] currentFrameData = new Vector3[(int)JointId.Count];
        for (int jointNum = 0; jointNum < (int)JointId.Count; jointNum++)
        {
            ...
            currentFrameData[jointNum] = jointPos; // 存储当前帧数据
            ...
            //// print the pelvis
            //if ((JointId)jointNum == JointId.Pelvis)
            //{
            //    // Output the world position of the Pelvis joint
            //    Debug.Log("Pelvis Position: " + positionInTrackerRootSpace);
            //}
        ...
        {
            recorder.RecordData(currentFrameData);
        }
    }
